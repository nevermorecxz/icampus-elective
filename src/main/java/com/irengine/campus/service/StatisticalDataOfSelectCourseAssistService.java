...
public class StatisticalDataOfSelectCourseAssistService {
	...
	public List<StatisticalDataOfSelectCourseAssist> save(
			List<StatisticalDataOfSelectCourseAssist> statisticalDataOfSelectCourseAssists) {
		return statisticalDataOfSelectCourseAssistDao.save(statisticalDataOfSelectCourseAssists);
	}
